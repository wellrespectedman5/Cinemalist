    ...
    (function () {
        $(document).on('change', '.js-select-multiple', function () {
            ...
            if (selectedValue != 'undefined') {
                ...
                var checkedItem = $self.find("option[value='" + selectedValue + "']"),
                    checkedIndex = $self.find("option[value='" + selectedValue + "']").index();
                ...
                selectList.append("<li class='selected-values__item'>" +
                    "<span class='selected-values__text'>" + checkedItem.html() + "</span>" +
                    "<a href='#' class='selected-value_single--remove' " +
                    "data-string-value='" + selectedValue + "'></a>" +
                    "</li>");
            }
        });

        $(document).on('click', '.selected-value_single--remove', function (e) {
            e.preventDefault();
            var $self = $(this),
                selRemoveVal = $self.data('string-value') + '',
                outputArray = [],
                inputHidden = $self.parents('.input-group').find("input[type=hidden]");
